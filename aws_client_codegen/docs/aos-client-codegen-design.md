...
2. AOS 使用独立入口 `aws_client_codegen/generate_aos_api.py`。
...
aws_client_codegen/api_spec/overlays/amazon-managed.overlay.yaml
```
...
```text
aws_client_codegen/generate_aos_api.py
```
...
```text
aws_client_codegen/api_spec/overlay.py
```
...
```text
aws_client_codegen/templates/aos/module
aws_client_codegen/templates/aos/root_client
aws_client_codegen/templates/aos/plugins_client
aws_client_codegen/templates/aos/package_init
```
...
8. `aws_client_codegen/templates/aos/module` 将方法放入 `UltrawarmClient`。
...
```bash
python -m aws_client_codegen.generate_aos_api
```
...
aws_client_codegen/generate_aos_api.py
aws_client_codegen/api_spec/overlay.py
aws_client_codegen/templates/aos/*
aws_client_codegen/docs/aos-client-codegen-design.md
```
...
- base spec 和 Overlay 固定存放在 `aws_client_codegen/api_spec/`，命令不要求路径参数。
