...
from ...client.utils import SKIP_IN_PATH, _bulk_body, _make_path, query_params
...
class AsyncAOSOpenSearch(Client):
    """Low-level client generated from the AOS data-plane OpenAPI."""
